...
export default function GraphForceLayout(props: Props) {
    ...
    //     const dragStarted = (event: D3DragEvent<SVGCircleElement, D3Types.Datum>, d: D3Types.Datum) => {
    //         console.log('event')
    //         console.log(event)
    //         console.log('d')
    //         console.log(d)
    ...
    //     function onDrag(event: D3DragEvent<SVGCircleElement, D3Types.Datum>, d: D3Types.Datum) {
    //         d.fx = event.x
    //         d.fy = event.y
    //     }

    //     function onDragEnd(event: D3DragEvent<SVGCircleElement, D3Types.Datum>, d: D3Types.Datum) {
    //         if (!event.active) {
    //             props.stopDrag()
    //         }
    //         d.fx = null
